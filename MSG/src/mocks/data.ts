...
export const userMessages: UserMessage[] = [
  { id:'UM-1001', title:'BTC/USDT 强平风险预警', summary:'您的合约账户保证金率已降至 18.6%，请及时处理仓位。', body:'BTC/USDT 永续仓位当前保证金率为 18.6%，标记价格为 58,420.5 USDT。市场波动可能导致仓位被强制平仓，请及时追加保证金或降低仓位。', category:'risk_notice', createdAt:'今天 18:06', read:false, risk:'紧急', source:'系统事件', actionText:'查看仓位', targetUrl:'/futures/positions', expiresAt:'2026-07-14 20:06' },
...
export const segments: AudienceSegment[] = [
  ...
  { id:'SEG-105', name:'高风险提现保护名单', type:'静态名单', purpose:'抑制', count:120480, change:3.1, refresh:'实时', updatedAt:'18:05', owner:'合规', status:'受保护', rule:'提现风险等级 ≥ 高 OR 账户状态 = 异常' },
];
...
export const deliveries: DeliveryRecord[] = [
  ...
  { id:'DLV-90005', task:'ETH 网络维护公告', user:'UID 72***01', destination:'站内账户', channel:'站内信', provider:'ForX Finance Inbox', status:'已送达', submittedAt:'17:55:10.002', deliveredAt:'17:55:10.018', retryCount:0, cost:'—' },
  ...
  { id:'DLV-90009', task:'VIP 等级月度通知', user:'UID 20***64', destination:'站内账户', channel:'站内信', provider:'ForX Finance Inbox', status:'已打开', submittedAt:'17:42:32.420', deliveredAt:'17:42:32.438', retryCount:0, cost:'—' },
...
export const providers: ChannelProvider[] = [
  { id:'CH-01', name:'ForX Finance Inbox', channel:'站内信', regions:'全球', status:'运行正常', successRate:99.999, latency:18, qps:12000, balance:'内部服务', priority:1 },
