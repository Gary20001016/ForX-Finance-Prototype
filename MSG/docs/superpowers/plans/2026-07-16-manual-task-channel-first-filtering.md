...
**Goal:** Move manual-message channel selection into “内容与多语言” and make the selected channels drive template availability, temporary content, translation readiness, preview, and the read-only sending-strategy summary.
...
- [x] **Step 1: Add the task channel policy**
...
- [x] **Step 2: Make message preview conditional by channel**
...
- [x] **Step 3: Check formatting and commit**
...
- [x] **Step 1: Introduce a single channel state**
...
- [x] **Step 2: Filter templates by coverage**
...
- [x] **Step 3: Add channel selection to step 1**
...
- [x] **Step 4: Make temporary content channel-specific**
...
- [x] **Step 5: Invalidate stale translation scope**
...
- [x] **Step 6: Filter template and temporary previews**
...
- [x] **Step 7: Make step 3 read-only**
...
- [x] **Step 8: Check formatting and commit**
...
- [x] **Step 1: Document the channel-first workflow**
...
- [x] **Step 2: Perform allowed static checks**
