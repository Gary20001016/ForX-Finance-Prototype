...
export default function ChannelManagementPage(){
  ...
  return <section className="page-stack">
    <PageHeader title="渠道管理" description="配置发送账号、供应商路由、限流、成本和故障切换。" actions={<Button type="primary" icon={<IconPlus/>} onClick={() => openPrototypeDialog('接入渠道供应商','选择渠道和适用地区，配置凭证引用、回调验签、限流、成本与故障切换策略。')}>接入供应商</Button>} />
