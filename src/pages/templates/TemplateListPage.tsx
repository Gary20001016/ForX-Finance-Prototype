...
export default function TemplateListPage() {
  ...
  return <section className="page-stack"><PageHeader title="消息模板" description="维护多语言、多渠道内容、变量和不可变发布版本。" actions={<Button type="primary" icon={<IconPlus />}>新建模板</Button>} />
